...
from pro.mod.lib.L_Tiempo import *  # importar con los mismos nombres
from pro.mod.lib.L_Requests import *  # importar con los mismos nombres
from pro.mod.M_Inf_Dispositivo import *  # importar con los mismos nombres
...
def clickbut_Tiempo(number):
        ...
        #Tiempo Torniquete
        Borrar_Archivo(30)      #Esatado chicharra
        Escrivir_Archivos(30,str(Tiempo_Torniquete))
                ...
                if N_Servidor.count('.') == 3:
                    ...
                    if Respuesta.find("Error") == -1:
                        ...
                        if Check_Res == True:
                            ...
                            print Variable_IP
                            Borrar_Archivo(32)
                            Escrivir_Archivo(Variable_IP,32) #N_A_Dominio_Servidor
                            # commands.getoutput('sudo reboot')
                            #Mensajes('Test OK,Esta IP es valida se cambiara, pero el dominio sera el mismo.','OK')
                        else:
                            print 'Test Error,La IP no Funciona'
...
def Tor_Derecha():
        Borrar_Archivo(13)
        Escrivir_Archivos(13,'D') #
def Tor_Izquierda():
        Borrar_Archivo(13)
        Escrivir_Archivos(13,'I') #
...
def Valores_Fabrica():
        ...
        #led
        Borrar_Archivo(10)      #led
        Escrivir_Archivos(10,'0')
        Borrar_Archivo(3)      #Estado led
        Escrivir_Archivos(3,'0')
        #tecla
        Borrar_Archivo(4)      #Esatado teclado
        Borrar_Archivo(5)      #Teclas
        #chicharra
        Borrar_Archivo(6)      #Esatado chicharra
        Escrivir_Archivos(6,'1')
        #Qr
        Borrar_Archivo(7)      #QR
        Borrar_Archivo(8)      #Estado QR
        Borrar_Archivo(9)      #Estado sensor
        Escrivir_Archivos(9,'0')
        Borrar_Archivo(11)      #Estado QR repetido
        #Torniquete
        Borrar_Archivo(13)      #Direcion Torniquete
        Escrivir_Archivos(13,'D')
        #Tiempo Torniquete
        Borrar_Archivo(30)      #Esatado chicharra
        Escrivir_Archivos(30,'1')



def Base_Datos_Local():

        Borrar_Archivo(0)       #borrar tabla servidor
        Borrar_Archivo(1)       #borrar tabla lector
        Borrar_Archivo(2)       #borrar tabla Enviar
        print 'Base datos borrado'

def Borrar_Historial():

       Borrar_Archivo(12)       #Borrar Numero de lecturas
       Escrivir_Archivos(12,'0') #dejar en 0 las lecturas

       Borrar_Archivo(14)       #Borrar Numero de Reinicios
       Escrivir_Archivos(14,'0') #dejar en 0 los reinicios
...
def Eliminar_IP_Dispostivos():
        ...
        if (len(Ip_dispostivo)==0):
                ...
                for x1 in M_T_lista["values"]:
                        #print x1
                        Escrivir_Archivos(21,x1)  # agragr uno a uno verificar *********
        ...
        if (len(Ip_dispostivo)==0):
                ...
                if (check_IP(Ip_dispostivo) == False) :
                        ...
                        if Valido == 1:
                                ...
                                Escrivir_Archivos(21,Ip_dispostivo)
                                #Actualizar_lista2()
                                M_T_lista.select_clear()
